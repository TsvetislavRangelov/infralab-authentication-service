package fhict.nl.infralabauthenticationservice.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fhict.nl.infralabauthenticationservice.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fhict.nl.infralabauthenticationservice.configuration.security.isauthenticated.IsAuthenticated)")
